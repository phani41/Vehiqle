...
CREATE TABLE "DealershipInfo" (
    ...
    "address" TEXT NOT NULL DEFAULT '69 Cars Street, Autoville, CA 69420',
...
-- CreateTable
CREATE TABLE "TestDrivesBooking" (
    "id" TEXT NOT NULL,
    "carId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "TestDrivesBooking_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "TestDrivesBooking_carId_idx" ON "TestDrivesBooking"("carId");

-- CreateIndex
CREATE INDEX "TestDrivesBooking_userId_idx" ON "TestDrivesBooking"("userId");

-- CreateIndex
CREATE INDEX "TestDrivesBooking_bookingDate_idx" ON "TestDrivesBooking"("bookingDate");

-- CreateIndex
CREATE INDEX "TestDrivesBooking_status_idx" ON "TestDrivesBooking"("status");
...
-- AddForeignKey
ALTER TABLE "TestDrivesBooking" ADD CONSTRAINT "TestDrivesBooking_carId_fkey" FOREIGN KEY ("carId") REFERENCES "Car"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TestDrivesBooking" ADD CONSTRAINT "TestDrivesBooking_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
